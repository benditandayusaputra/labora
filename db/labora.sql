...
INSERT INTO `clubs` (`id`, `name`, `abbreviation`, `owner`, `hp`, `address`, `created_at`, `updated_at`) VALUES
(1, 'Tenis Meja', 'TM', NULL, NULL, NULL, NULL, NULL);
...
--
-- Struktur dari tabel `register_tournaments`
--
...
CREATE TABLE `tournaments` (
  ...
  `start_regist` datetime DEFAULT NULL,
  `finish_regist` datetime DEFAULT NULL,
...
--
-- Indeks untuk tabel `register_tournaments`
--
